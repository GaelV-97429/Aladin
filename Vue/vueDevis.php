...
<head>
	...
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  	...
  	<script type="text/javascript" src="Autre/fonctionDev.js"></script>
  	<script type="text/javascript">
<?php /*
	$listeDevis = "var listeDevis = {\n";
	$i = 0;
	$z = 0;
...
<body>
	<div class="container" id="dev"><?= $AfficheDevis ?></div>
	...
	<div class="container" id="containerProd1">
		...
		<div class="row">
			<div class="col-sm-12" style="color: #0033FF; background-image: linear-gradient(to bottom, white -20%, orange 70%);">Devis</div>
		</div>
...
?>
			...
			<div class="row">
				<div class="col-sm-12">
					<select id="PrixDev" onchange="ChangePrix()">
			...
			<div class="row" style="margin-top: 1%;">
				<div class="col-sm-12"><input type="text" id="Boncommande"  placeholder="N&#146; bon de commande"></div>
			</div>
		</div>
...
?>
		...
		<div id="CliClick" style="margin: 0; padding: 0;"></div>
	...
	<div class="container" id="containerProd2">
		<div class="row" style="border-bottom: 1px solid black; height: 40px; padding-top: 2px;">
			<div class="col-sm-9" style="padding-left: 8%; font-weight: bold; font-size: 13px; color: #990099; height: 30px; padding-top: 2px; font-size: 18px; text-shadow: 2px 5px #BBBBBB"><strong>Résultat <span id="NumDuDev">0</span>/<span id="NbDevMax">0</span></strong></div>
			<div class="col-sm-2">
				<button class="btn btn-primary disabled" title="Supprimez le devis s&eacute;lectionn&eacute;" style="height: 30px; padding: 0; width: 35px; float: right; margin-left: 5px;"><span class="glyphicon glyphicon-remove-sign"></span></button>
				<button class="btn btn-primary disabled" title="Ajoutez un devis" style="height: 30px; padding: 0; width: 35px; float: right; margin-left: 5px;"><span class="glyphicon glyphicon-exclamation-sign"></span></button>
			</div>	
		</div>
		<div class="row">
		...
		<input type="number" id="SaveLigneDevis" hidden value="0">
...
?>
			<div class="row">
				<input type="number" id="indexDevis<?= $i ?>" value="0" hidden>
				<div class="col-sm-1"></div>
				<div class="col-sm-10">
					<div class="row">
						<div class="col-sm-1" onclick="selecDev(<?= $i ?>)" oncontextmenu="infoDev('open',<?= $i ?>); return false;" style="height: 20px; width: 134px; border: 1px solid black; border-right: none; border-top: none; background-color: white;" id="num<?= $i ?>"></div>
						<div class="col-sm-1" onclick="selectDev(<?= $i ?>)" oncontextmenu="infoDev('open',<?= $i ?>); return false;" style="height: 20px; width: 134px; border: 1px solid black; border-right: none; border-top: none; background-color: white;" id="cli<?= $i ?>"></div>
						<div class="col-sm-1" onclick="selectDev(<?= $i ?>)" oncontextmenu="infoDev('open',<?= $i ?>); return false;" style="height: 20px; width: 134px; border: 1px solid black; border-right: none; border-top: none; background-color: white;" id="le<?= $i ?>"></div>
						<div class="col-sm-1" onclick="selectDev(<?= $i ?>)" oncontextmenu="infoDev('open',<?= $i ?>); return false;" style="height: 20px; width: 134px; border: 1px solid black; border-right: none; border-top: none; background-color: white;" id="echeance<?= $i ?>"></div>
						<div class="col-sm-1" onclick="selectDev(<?= $i ?>)" oncontextmenu="infoDev('open',<?= $i ?>); return false;" style="height: 20px; width: 134px; border: 1px solid black; border-right: none; border-top: none; background-color: white;" id="bc<?= $i ?>"></div>
						<div class="col-sm-1" onclick="selectDev(<?= $i ?>)" oncontextmenu="infoDev('open',<?= $i ?>); return false;" style="height: 20px; width: 134px; border: 1px solid black; border-right: none; border-top: none; background-color: white;" id="HT<?= $i ?>"></div>
						<div class="col-sm-1" onclick="selectDev(<?= $i ?>)" oncontextmenu="infoDev('open',<?= $i ?>); return false;" style="height: 20px; width: 134px; border: 1px solid black; border-top: none; background-color: white;" id="TTC<?= $i ?>"></div>
					</div>
				</div>
				<div class="col-sm-1"></div>
			</div>
...
?>
	...
	<div class="container" id="containerProd3">
		<div class="row">
			<div class="col-sm-5" style="color: #990099; font-weight: bold; font-size: 15px; padding-left: 8%;"><strong>Produits</strong></div>
			<div class="col-sm-6">
		...
		<div class="row" style="overflow: scroll; overflow-x: hidden;">
			<div class="row">
				...
				<div class="col-sm-10">
					<div class="row" style="margin-top: 1%;">
						<div class="col-sm-3" style="height: 20px; width: 188px; border: 1px solid black; border-right: none; background-color: #222222; opacity: 0.9; color: white; letter-spacing: 0.1em"><strong>R&eacute;f&eacute;rence</strong></div>
						<div class="col-sm-3" style="height: 20px; width: 188px; border: 1px solid black; border-right: none; background-color: #222222; opacity: 0.9; color: white; letter-spacing: 0.1em"><strong>D&eacute;signation</strong></div>
						<div class="col-sm-3" style="height: 20px; width: 188px; border: 1px solid bla87; background-color: #222222; opacity: 0.9; color: white; letter-spacing: 0.1em"><strong>Qt&eacute;</strong></div>
						<div class="col-sm-3" style="height: 20px; width: 188px; border: 1px solid black; background-color: #222222; opacity: 0.9; color: white; letter-spacing: 0.1em"><strong>P.U.H.T. (&euro;)</strong></div>
						<div class="col-sm-3" style="height: 20px; width: 188px; border: 1px solid black; background-color: #222222; opacity: 0.9; color: white; letter-spacing: 0.1em"><strong>TOTAL H.T. (&euro;)</strong></div>
					</div>
				</div>
				<div class="col-sm-1"></div>
			</div>
...
?>
			...
			<input type="number" id="indexCli<?= $i ?>" value="0" hidden>
				...
				<div class="col-sm-10">
					<div class="row">
						<div class="col-sm-3" style="height: 20px; width: 188px; border: 1px solid black; border-right: none; border-top: none; background-color: white;" id="ref<?= $i ?>"></div>
						<div class="col-sm-3" style="height: 20px; width: 188px; border: 1px solid black; border-right: none; border-top: none; background-color: white;" id="design<?= $i ?>"></div>
						<div class="col-sm-3" style="height: 20px; width: 188px; border: 1px solid black; border-right: none; border-top: none; background-color: white;" id="qte<?= $i ?>"></div>
						<div class="col-sm-3" style="height: 20px; width: 188px; border: 1px solid black; border-right: none; border-top: none; background-color: white;" id="PUHT<?= $i ?>"></div>
						<div class="col-sm-3" style="height: 20px; width: 188px; border: 1px solid black; border-top: none; background-color: white;" return false;" id="TOTALTTC<?= $i ?>"></div>
					</div>
				</div>
				<div class="col-sm-1"></div>
			</div>
...
?>
		...
		<div class="row"><div class="col-sm-12" style="border-top: 1px solid black; width: 100%; margin-top: -0.6%;"></div></div>
			...
			<div class="col-sm-4" style="text-align: right;">
				<button onclick="enregistrer()" style="width:100px; height: 45px; margin-right: 15px; background-color: #DB7093; padding: 1px; border: 1px solid lightgreen; color: #444444; font-size: 15px;" class="btn btn-warning" id="btnSave"><span class="glyphicon glyphicon-floppy-disk"></span><br>Enregistrer</button>
